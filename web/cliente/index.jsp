...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/window-down.css"
  </head>
  <body>
    ...
    <div class="wrapper fade-in-down">
      <div class="form-content">
        <div class="my-3 fade-in then">
          <img src="<%=request.getContextPath()%>/img/logo2.png" style="width:220px; padding-top: 10px" id="icon" alt="Ícone do sistema" />
